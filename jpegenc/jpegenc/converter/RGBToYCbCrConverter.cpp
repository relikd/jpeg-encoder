...
void RGBToYCbCrConverter::convert(std::shared_ptr<Image> image) {
	...
	while (index--) {
        ...
        color y  = (color)    (0.299f * r +    0.587f * g +    0.114f * b)       ;
		color cb = (color)(-0.168736f * r - 0.331264f * g +      0.5f * b + 0.5f); // 0.5 == +128
		color cr = (color)      (0.5f * r - 0.418688f * g - 0.081312f * b + 0.5f); // 0.5 == +128
